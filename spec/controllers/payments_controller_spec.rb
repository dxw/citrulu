...
describe PaymentsController do
  ...
  describe "GET 'choose_plan'" do
    before(:each) do
      plan = double('Plan')
      plan.stub(:number_of_sites)
      plan.stub(:mobile_alerts_allowance)
      
      Plan.stub(:cornichon).and_return(plan)
      Plan.stub(:gherkin).and_return(plan)
      Plan.stub(:cucumber).and_return(plan)
      Plan.any_instance.stub(:number_of_sites)
      get :choose_plan
    end
