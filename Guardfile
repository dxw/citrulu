...
guard 'rspec', cmd: "zeus test --tty --color" do
  # A few things are heavily dependent on the citrulu parser
  watch('lib/grammar/parser.rb') { ["spec/lib/grammar/parser.rb", "spec/models/test_file_spec.rb"] }
